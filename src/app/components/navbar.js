...
export default function Navbar() {
    ...
    return (
        <div className="bg-white shadow-lg h-24 hidden md:flex md:justify-evenly">
            ...
            <div className="  flex items-center gap-5 px-4 lg:px-6 xl:px-8">
                ...
                <div className=''>
                    <button className=" bg-orange-600 hover:bg-orange-500 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center gap-3">
