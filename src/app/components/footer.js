...
const Footer = () => {
  return (
    <>
      <div className="relative z-10 bg-white pb-10 pt-20  lg:pb-20 lg:pt-[120px]">
        ...
        <div className="">
          ...
          <div className="mx-4 flex flex-wrap">
              ...
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  ...
                  <img
                    ...
                    alt="logo"
                    className="max-w-full hidden d"
                  /> */}
                  <h1 className="text-2xl font-bold">PG-AGI</h1>
                </a>
                <p className="mb-7 text-base text-body-color ">
                 This is an example text for the footer. It can be used to describe the company or the website.
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-bold text-dark ">
                  Follow Us On
                </h4>
                <div className="mb-6 flex items-center">
                  ...
                  <a
                    href="javascript:void(0)"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-whitesm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="16"
                      height="12"
  ...
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          <h4 className="mb-9 text-lg font-bold text-dark underline underline-offset-8 text-primary">
            {header}
          </h4>
