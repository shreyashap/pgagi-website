  ...
  return (
    <div style={{ backgroundColor: 'black' }}>
      <div className="flex flex-col">
        <div style={{ height: '10%', marginLeft: '40px', marginRight: '40px', marginTop: '40px' }}>
          <img
        ...
        <p className='text-md text-center '>We are on the cusp of something transformative, fuelled by excitement and a shared vision for the future. If this journey resonates with you, we welcome you to join us. Reach out at hiring@pgagi.in, and lets explore the possibilities together.<br></br>With anticipation <br></br> Vivek, Sanjay, Shibajyoti, Parikshit, and the entire PGAGI team</p>
